...
public final class DeletedFiles extends EntryMetricModel {
	...
	@Override
	public final void evaluate(final Commit entry, final EntryMetricValues table) throws DatabaseException {
		table.setEntryDeletedFiles(new CommitDAO().countEntryDeletedFiles(entry.getId()));
	}
