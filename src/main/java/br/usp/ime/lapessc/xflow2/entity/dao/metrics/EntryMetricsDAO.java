...
public class EntryMetricsDAO extends MetricModelDAO<EntryMetricValues> {
	...
	public EntryMetricValues findEntryMetricValuesByEntry(final Metrics analysis, final Commit entry) throws DatabaseException {
	...
	public int getAddedFilesValueByEntry(final Metrics analysis, final Commit entry) throws DatabaseException {
		final String query = "select values from entry_metrics values where values.associatedMetricsObject = :analysis and values.entry = :entry";
		final Object[] parameter1 = new Object[]{"analysis", analysis};
		final Object[] parameter2 = new Object[]{"entry", entry};
	...
	public int getModifiedFilesValueByEntry(final Metrics analysis, final Commit entry) throws DatabaseException {
		final String query = "select values from entry_metrics values where values.associatedMetricsObject = :analysis and values.entry = :entry";
		final Object[] parameter1 = new Object[]{"analysis", analysis};
		final Object[] parameter2 = new Object[]{"entry", entry};
	...
	public int getDeletedFilesValueByEntry(final Metrics analysis, final Commit entry) throws DatabaseException {
		final String query = "select values from entry_metrics values where values.associatedMetricsObject = :analysis and values.entry = :entry";
		final Object[] parameter1 = new Object[]{"analysis", analysis};
		final Object[] parameter2 = new Object[]{"entry", entry};
	...
	public int getEntryLOCValueByEntry(final Metrics analysis, final Commit entry) throws DatabaseException {
		final String query = "select values from entry_metrics values where values.associatedMetricsObject = :analysis and values.entry = :entry";
		final Object[] parameter1 = new Object[]{"analysis", analysis};
		final Object[] parameter2 = new Object[]{"entry", entry};
	...
	@Override
	public List<EntryMetricValues> getMetricsTableFromAuthorByEntries(Metrics metrics, Author author, Commit initialEntry, Commit finalEntry) throws DatabaseException {
