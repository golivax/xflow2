...
package br.usp.ime.lapessc.xflow2.presentation.commons.util.prefuse;
...
import br.usp.ime.lapessc.xflow2.presentation.Visualizer;
import br.usp.ime.lapessc.xflow2.presentation.commons.util.ColorPalette;
import br.usp.ime.lapessc.xflow2.presentation.view.SingleProjectView;
	...
	public int getColor(VisualItem item) {
		...
		if ( item instanceof NodeItem ) {
			...
			if ( m_vis.isInGroup(item, Visualization.SEARCH_ITEMS) ) {
				for(int i=0; i < ((SingleProjectView) Visualizer.getProjectsViewer()).developersPanelControl.getDevelopersList().size(); i++){
			...
			//FIXME: I removed JCustomSearchPanel
