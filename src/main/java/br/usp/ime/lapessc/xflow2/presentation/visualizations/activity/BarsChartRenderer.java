package br.usp.ime.lapessc.xflow2.presentation.visualizations.activity;
...
//		domainAxis.setLabelInsets(new RectangleInsets(20,20,20,20));
	...
	private void createDatasets(Metrics metrics) throws DatabaseException{
		...
		List<Author> authorsList = 
				new AuthorDAO().getAuthorsListByEntries(
						metrics.getAssociatedAnalysis().getProject(),
						metrics.getAssociatedAnalysis().getFirstEntry(), 
						metrics.getAssociatedAnalysis().getLastEntry());
